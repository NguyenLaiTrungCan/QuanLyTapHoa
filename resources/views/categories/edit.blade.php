    ...
    <div class="col-lg-8">
        <div class="soft-card overflow-hidden">
            <div class="p-4 p-lg-5" style="background: linear-gradient(135deg, rgba(34,197,94,.12), rgba(250,204,21,.10));">
                <div class="section-badge mb-3"><i class="bi bi-pencil-square"></i> Category Edit</div>
                <h1 class="page-title h3 mb-2">Chỉnh Sửa Danh Mục</h1>
                <p class="text-muted mb-0">Cập nhật tên và mô tả danh mục trong cùng một phong cách với trang tạo mới.</p>
            </div>
